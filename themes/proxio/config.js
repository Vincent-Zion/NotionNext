...
const CONFIG = {
    ...
    PROXIO_WELCOME_TEXT: '欢迎来到我的个人网站，点击任意位置进入', // 欢迎文字，留空则不启用

    // 英雄区块导航
    PROXIO_HERO_ENABLE: true, // 开启英雄区
    PROXIO_HERO_TITLE_1: '我是一名有信仰的嵌入式软件工程师', // 英雄区文字
    PROXIO_HERO_TITLE_2: '【哥林多后书 5:7】因我们行事为人是凭着信心，不是凭着眼见。', // 英雄区文字
    ...
    PROXIO_BLOG_COUNT: 20, // 首页博文区块展示前20篇文章
    ...
    */
    ...
    PROXIO_FAQ_TITLE: '关于我',
    PROXIO_FAQ_TEXT_1: '想了解我多一点？请往下看',
    PROXIO_FAQ_TEXT_2: '我用简洁的问答方式，写下我的真实与热爱',
    PROXIO_FAQS: [
    {
        q: '你相信什么？',
    ...
    {
        q: '你为什么创建这个网站？',
        a: '我希望这里成为一块净土，用来记录我信仰的旅程、生命的见证，也分享一点技术笔记，方便有需要的人。'
    },
    {
        q: '你对生活有什么看法？',
