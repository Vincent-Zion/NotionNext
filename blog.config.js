...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Be Strong in the Kingdom', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bsk41.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '信仰, 博客, Faith', // 网站关键词 英文逗号隔开
